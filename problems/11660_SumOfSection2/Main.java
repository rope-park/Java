/* 
    ...
    * 풀이 방법: 
        1. 2차원 배열을 생성하여 입력받은 값을 저장한다.
        2. 2차원 배열을 생성하여 구간합을 저장한다.
        3. 구간합을 구하는 공식은 arrSum[x][y] = arrSum[x][y - 1] + arrSum[x - 1][y] - arrSum[x - 1][y - 1] + arr[x][y] 이다.
        4. 구간합을 구하는 공식에 따라 구간합을 구한다.
